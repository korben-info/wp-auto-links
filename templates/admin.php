...
$instance = WP_Auto_Links_Helper::get_instance();
...
if (isset($_POST['submitted'])) {
    ...
    echo '<div class="updated"><p>' . __('Plugin settings saved.', $instance::DOMAIN) . '</p></div>';
}
...
function not_null($value, int $null = 0): bool
{
    return (is_numeric($value) && $value > 0) ? (int) $value : $null;
}

$options['max_links'] = not_null($options['max_links']);
$options['max_single_keyword'] = not_null($options['max_single_keyword'], -1);
$options['max_single_url'] = not_null($options['max_single_url']);
$options['min_term_usage'] = not_null($options['min_term_usage'], 1);
...
<div class="wrap">
    ...
    <form method="post" action="<?= $_SERVER['REQUEST_URI']; ?>">
        ...
        <input type="hidden" id="_wpnonce" name="_wpnonce" value="<?= wp_create_nonce($instance::DOMAIN); ?>"/>
        <input type="hidden" name="submitted" value="1"/>

        <h2 class="title"><?php _e('Keywords'); ?></h2>
        <p><?php _e('Which custom keywords to automatically link.', $instance::DOMAIN); ?></p>
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <p class="description">
                        <?php _e('Use comma to separate keywords and add target url at the end. Use a new line for new url and set of keywords. You can have these keywords link to any url, not only your site.', $instance::DOMAIN); ?>
                    </p>
            ...
            <tr>
                <th><?php _e('Duplicates', $instance::DOMAIN); ?></th>
                <td>
                    <label>
                        <input type="checkbox" name="prevent_duplicate_link" <?= $options['prevent_duplicate_link']; ?> />
                        <strong><?php _e('Prevent a link to be used more than once in a content', $instance::DOMAIN); ?></strong>
                    </label>
                </td>
            </tr>
            </tbody>
        ...
        <h2 class="title"><?php _e('Placements', $instance::DOMAIN); ?></h2>
        <p><?php _e('Where to automatically add links.', $instance::DOMAIN); ?></p>
        <table class="form-table">
            <tbody>
            <tr>
                <th><?php _e('Posts'); ?></th>
                <td>
                    ...
                    <label>
                        ...
                        <strong><?php _e('Enable self linking for posts', $instance::DOMAIN); ?></strong>
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <label>
                        ...
                        <strong><?php _e('Enable self linking for pages', $instance::DOMAIN); ?></strong>
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <?= $instance->may_slow_down(); ?>
                </td>
            </tr>
            <tr>
                <th><?php _e('Feeds', $instance::DOMAIN); ?></th>
                <td>
                    <label>
                        <input type="checkbox" name="on_feed" <?= $options['on_feed']; ?> />
                        <strong><?php _e('Enable to link in feeds', $instance::DOMAIN); ?></strong>
                    </label>
                    <p class="description">
            ...
            <tr>
                <th><?php _e('Archives', $instance::DOMAIN); ?></th>
                <td>
                    <label>
                        <input type="checkbox" name="on_archive" <?= $options['on_archive']; ?>/>
                        <strong><?php _e('Enable to link on archive and index pages (including home page)', $instance::DOMAIN); ?></strong>
                    </label>
                    <?= $instance->may_slow_down(); ?>
                </td>
            </tr>
            <tr>
                <th><?php _e('Heading', $instance::DOMAIN); ?></th>
                <td>
                    <label>
                        <input type="checkbox" name="on_heading" <?= $options['on_heading']; ?>/>
                        <strong><?php _e('Enable to link in heading tags (h1, h2, h3, h4, h5 and h6)', $instance::DOMAIN); ?></strong>
                    </label>
                </td>
            </tr>
            </tbody>
        ...
        <h2 class="title"><?php _e('Targeting', $instance::DOMAIN); ?></h2>
        <p><?php _e('What to automatically link.', $instance::DOMAIN); ?></p>
        <table class="form-table">
            <tbody>
            <tr>
                ...
                <td>
                    <label>
                        ...
                        <strong><?php _e('Enable to link links with custom keywords', $instance::DOMAIN); ?></strong>
                    </label>
                    <?= $instance->may_slow_down(); ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        ...
                        <strong><?php _e('Enable to link internal links to posts', $instance::DOMAIN); ?></strong>
                    </label>
                    <?= $instance->may_slow_down(); ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        ...
                        <strong><?php _e('Enable to link internal links to pages', $instance::DOMAIN); ?></strong>
                    </label>
                    <?= $instance->may_slow_down(); ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        ...
                        <strong><?php _e('Enable to link internal links to categories', $instance::DOMAIN); ?></strong>
                    </label>
                    <?= $instance->may_slow_down(); ?>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <label>
                        ...
                        <strong><?php _e('Enable to link internal links to tags', $instance::DOMAIN); ?></strong>
                    </label>
                    <?= $instance->may_slow_down(); ?>
                </td>
            </tr>
            <tr>
                <th>
                    <label for="min_term_usage">
                        <?php _e('Minimum categories / tags', $instance::DOMAIN); ?>
                    </label>
                </th>
                <td>
        ...
        <h2 class="title"><?php _e('Excluding', $instance::DOMAIN); ?></h2>
        <table class="form-table">
            <tbody>
            <tr>
                <th><?php _e('Exclude Keywords', $instance::DOMAIN); ?></th>
                <td>
                    <input type="text" name="keyword_ignore" size="90"
                           value="<?= $options['keyword_ignore']; ?>" placeholder="<?php _e('Add a word', $instance::DOMAIN); ?>"/>
                    <p class="description">
                        <?php _e('You may wish to ignore certain words or phrases from automatic linking. Separate them by comma.', $instance::DOMAIN); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th><?php _e('Exclude Posts / Pages', $instance::DOMAIN); ?></th>
                <td>
                    <input type="text" name="post_ignore" size="90"
                           value="<?= $options['post_ignore']; ?>" placeholder="<?php _e('Add an ID'); ?>"/>
                    <p class="description">
                        <?php _e('You may wish to forbid automatic linking on certain posts or pages. Separate their ID by a comma.', $instance::DOMAIN); ?>
                    </p>
                </td>
            </tr>
            <tr>
                <th><?php _e('Exclude Categories / Tags', $instance::DOMAIN); ?></th>
                <td>
                    <input type="text" name="term_ignore" size="90"
                           value="<?= $options['term_ignore']; ?>" placeholder="<?php _e('Add an ID', $instance::DOMAIN); ?>"/>
                    <p class="description">
                        <?php _e('You may wish to forbid automatic linking on certain categories or tags. Separate their ID by a comma.', $instance::DOMAIN); ?>
                    </p>
                </td>
            </tr>
            </tbody>
        ...
        <p><?php _e('How automatically link', $instance::DOMAIN); ?></p>
        <table class="form-table">
            <tbody>
            <tr>
                <th>
                    <label for="max_links">
                        <?php _e('Max Links', $instance::DOMAIN); ?>
                    </label>
                </th>
                <td>
            ...
            <tr>
                <th>
                    <label for="max_single_keyword">
                        <?php _e('Max Keyword Links', $instance::DOMAIN); ?>
                    </label>
                </th>
                <td>
            ...
            <tr>
                <th>
                    <label for="max_single_url">
                        <?php _e('Max Same URLs', $instance::DOMAIN); ?>
                    </label>
                </th>
                <td>
            ...
            <tr>
                <th><?php _e('Case sensitive', $instance::DOMAIN); ?></th>
                <td>
                    <label>
                        <input type="checkbox" name="case_sensitive" <?= $options['case_sensitive']; ?> />
                        <strong><?php _e('Enable case sensitivity', $instance::DOMAIN); ?></strong>
                    </label>
                </td>
            </tr>
            <tr>
                <th><?php _e('No follow', $instance::DOMAIN); ?></th>
                <td>
                    <label>
                        <input type="checkbox" name="link_nofollow" <?= $options['link_nofollow']; ?>/>
                        <strong><?php _e('Add a nofollow attribute to the external links.', $instance::DOMAIN); ?></strong>
                    </label>
                </td>
            </tr>
            <tr>
                <th><?php _e('Open in new window', $instance::DOMAIN); ?></th>
                <td>
                    <label>
                        <input type="checkbox" name="link_blank" <?= $options['link_blank']; ?>/>
                        <strong><?php _e('Open the external links in a new window.', $instance::DOMAIN); ?></strong>
                    </label>
                </td>
            </tr>
            </tbody>
